...
- 인스타 업로드 테스트 시 ENABLE_INSTAGRAM_UPLOAD=true 로 변경 후 확인
...
6) 현재 코드 동작 요약
- 30분마다 실행 권장
- 속보: 인스타 업로드 선택 동작(USE_INSTAGRAM_FOR_BREAKING=true)
- 정규시간(08:00, 19:00 KST): 랭크 카드 + 릴스 자동 생성
- 정규 릴스: ENABLE_INSTAGRAM_UPLOAD=true 일 때만 인스타 자동 업로드
